...
class Ui_WizardPage2(object):
    ...
    def retranslateUi(self, WizardPage2):
        ...
        WizardPage2.setTitle(QCoreApplication.translate("WizardPage2", u"Sandbox Credentials", None))
        WizardPage2.setSubTitle(QCoreApplication.translate("WizardPage2", u"From here you will configure your Ebay sandbox API credentials.", None))
